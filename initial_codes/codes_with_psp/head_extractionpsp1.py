...
for line in f:
    ...
    if (line.rstrip()):
        ...
        if (line1[0] == "<Sentence"):
            ...
            fill = "H " + head + " " + head_lemma + " " +  head_o_pos + " " + head_pos + " " + head_name + " " + head_relation + " " +  head_relative_name + " " + psp
            ...
            if(len(chunk_words)):
                ...
                dependencies.append("H " + head + " " + head_lemma + " " +  head_o_pos + " " + head_pos + " " + head_name + " " + head_relation + " " +  head_relative_name + " " + psp)
